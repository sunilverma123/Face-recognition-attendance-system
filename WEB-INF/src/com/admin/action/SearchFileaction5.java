...
public class SearchFileaction5 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
		...
		try {
			...
			String fileName = request.getRealPath("") + "/File/search2/"+m+"_"+ file.getName();
			...
			inputStream.close();
			 ...
			 request.setAttribute("image_name",m+"_"+ file.getName());
           	rd=request.getRequestDispatcher("/res/jsp/admin/upload5.jsp?no=11");
